...
<div class="main" >
  ...
  <div style="color: white; padding: 5px 50px 50px 50px; float: right; font-size: 16px;">
   ...
   <a href="desti.php" class="button2" style="margin-top:12px; border-radius:10px;">Back</a> 
   </div>
...
<?php
$query="select * from flight where to_flight=:to_flight  ";
