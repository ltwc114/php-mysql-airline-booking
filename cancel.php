...
<body>
<h1 class="header-w3ls">Cancel Flight</h1>
                          
<div class="content-w3ls">
       </font> 
	<div class="form-w3ls">
	
    <form method="post" action="wcancel.php">
			<div class="content-wthree1">
			<div class="grid-agileits1">
			
            <div class="form-control"> 
			<label class="header">Email id: </label>
			<input type="text" id="name" name="email" placeholder="Enter Email Id" title="Please enter a Valid Email Address" required="">
			</div>
		
			<div class="form-control">	
			<label class="header">Mobile no: </label>
			<input type="text" id="name" name="num" placeholder="Enter mobile number" title="Please enter a Valid Mobile no" required="">
			</div>
