			...
			<div class="pad_1"  >
				...
				<form id="form_1" action="<?php $_SERVER['PHP_SELF'] ?>" method="post" >
					...
					<div class="wrapper">
						...
						<div class="wrapper"">
							<div class="bg left">
                            <input type="date" ; name="date" style="width:230px; height:30px; class="input input2">
                            </div>
                            </input>
...
<div style=" height:750px;width:1380px;">   
<div style=" height:460px;width:980px; margin-left:350px	;position:absolute;">   
                    <br />
  <font style="margin-left:20px;"> dear,</font><br />

<font style="margin-left:40px;"><?php echo $_SESSION["name"]; ?>,</font>

<font>Thank you choosing us.Yor Flight is booked.<br />
<br /></font>
<font style="margin-left:40px;"><a href="cancel.php">Click here to cancel flight.</a></font>
